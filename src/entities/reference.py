...
if __name__ == "__main__":  # pragma: no cover
    #tämä toimii 
    test = Reference(1, 'article', 'Orange Cat', 'How to Dominate The world', '2005', 'Cat Chronicles', pp='200-300')
    test2 = Reference(2, 'book', 'Black Cat', 'How to Jump', '2024', publisher='Brother')
    print(test)
    print(test2)
